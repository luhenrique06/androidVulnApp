...
object Util {
    ...
    fun showAlert(context: Context, title: String, message: String, positiveButtonTitle: String = "OK", negativeButtonTitle: String? = null, positiveAction: (() -> Unit)? = null, negativeAction: (() -> Unit)? = null) {
